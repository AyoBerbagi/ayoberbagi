...
<body class="index-page sidebar-bagi8d54a2collapse">
    ...
    <div class="wrapper">
        <div class="page-header clear-filter" filter-color="orange">
            <div class="page-header-image" data-parallax="true" style="background-image: url('./assets/img/potret.jpg');">
            	
            </div>
          <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-8 fotoo">
                            <h2><b>Apa itu Ayoberbagi?</b></h2>
                            <h3>Ayo berbagi adalah platform untuk menggalang dana secara online (crowdfunding)</h3>
                                    </div>
                                </div>
            </div>
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-10">
                          ...
                          Kenapa berdonasi melalui Ayo Berbagi?
                        </div>
