...
<body class="index-page sidebar-bagi8d54a2collapse">
   ...
   <div class="section section-signup" style="background-image: url('<?=base_url()?>/assets/img/Bgbarang.jpg'); background-size: cover; background-position: top center; min-height: 700px;">
      ...
      <div class="container marketing">
        ...
        <div class="row">
          <div class="col-lg-4">
            <img class="rounded-circle" src="<?=base_url()?>/assets/img/barang1.jpg" alt="Generic placeholder image" width="140" height="140">
            <h2>Buku Untuk Soleh</h2>
            <p>Sekolah Bukit Tinggi memerlukan bantuan buku untuk pembalajaran sekolah mereka yang baru saja terkena gempa. Donasikan buku-buku yang kamu punya untuk anak-anak sekolah Bukit Tinggi.Target Buku 250 Buku</p>
            <h4>Progress Barang</h4>
                            <div class="progress-container progress-primary">
                                <span class="progress-badge">Terkumpul dari target 250 Buku</span>
                                <div class="progress">
