                ...
                <thead>
                  ...
                  <tbody>
                      ...
                      <tr>
                        ...
                        <td scope="col"><?php echo $u->nama_desa ?></td>
                        <td scope="col"><?php echo $u->alamat_desa ?></td>
                        <td scope="col"><?php echo $u->aks_status ?></td>
                        <td scope="col">
                        <a
                            href="javascript:;"
                            data-id="<?php echo $u->id_aksisosial ?>"
                            data-nama="<?php echo $u->nama_desa ?>"
                            data-alamat="<?php echo $u->alamat_desa ?>"
          ...
          <div class="modal-dialog">
              <div class="modal-content">
                  <div class="modal-header">
                      ...
                      <h4 class="modal-title">Verifikasi Pengabdian Masyarakat</h4>
                  </div>
                  <form class="form-horizontal" action="<?=base_url()?>Admin/verifikasi_aksi" method="post" enctype="multipart/form-data" role="form">
