                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4" >
                          ...
                          <li ><a href="<?=base_url()?>FAQ/panduan">Panduan Umum</a> <span class="pull-right fa fa-chevron-right"></span></li></button>
                               <button class="btn btn-primary col-md-10" id="borderbox">
                          <li><a href="<?=base_url()?>FAQ/campaigner"></a>Untuk Campaigner<span class="pull-right fa fa-chevron-right"></span></li></button>
                               <button class="btn btn-primary col-md-10" id="borderbox">
                          <li class="active"><a href="<?=base_url()?>FAQ"></a>Aksi Sosial<span class="pull-right fa fa-chevron-right"></span></li></button>
                                <button class="btn btn-primary col-md-10" id="borderbox">
                          <li><a href="<?=base_url()?>FAQ/"></a>Pencairan Dana<span class="pull-right fa fa-chevron-right"></span></li></button>
                               <button class="btn btn-primary col-md-10" id="borderbox">
                          <li><a href="<?=base_url()?>FAQ/donatur"></a>Untuk Donatur<span class="pull-right fa fa-chevron-right"></span></li></button>
                                <button class="btn btn-primary col-md-10" id="borderbox">
                          <li><a href="<?=base_url()?>FAQ/berbagibarang"></a>Berbagi Barang<span class="pull-right fa fa-chevron-right"></span></li></button>
                       </ul>
                        </div>
                        <div class="col-md-8">
                            <div class="row">
                         ...
                         <input type="text" value="" placeholder="Cari Pertannyaanmu ..." class="form-control">
                                    </div>
  ...
  <div class="card">
    <div class="card-header" id="headingOne">
      <h5 class="mb-0">
        <button class="btn btn-link" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
          Apakah Ayoberbagi.com langsung memberikan dana?
        </button>
      </h5>
    </div>
    ...
    <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
       Tidak.
          <br>
        Ayoberbagi.com hanya memberikan fasilitas website untuk menggalang dana secara online.kami tidak memiliki dana yang bisa disalurkan. Keberhasilan sebuah penggalangan dana sangat bergantung pada kualitas konten, luas jaringan dan upaya galang dana yang dilakukan.
      </div>
    </div>
  </div>
  <div class="card">
    <div class="card-header" id="headingTwo">
      <h5 class="mb-0">
        <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
          Siapa saja yang bisa menggalang dana di Ayoberbagi.com?
        </button>
      </h5>
    </div>
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
      <div class="card-body">
            Ayoberbagi memfasilitasi siapa saja yang ingin menggalang dana.
            Ayoberbagi telah digunakan oleh ribuan pengguna mulai dari NGO global, yayasan lokal, komunitas, himpunan alumni, mahasiswa, artis, hingga individu/pribadi yang ingin menggalang dana untuk tujuan sosial, membantu sesama atau menciptakan karya.
      </div>
    </div>
  </div>
  <div class="card">
    <div class="card-header" id="headingThree">
      <h5 class="mb-0">
        <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
          Apakah Kitabisa melakukan verifikasi terhadap proposal
          galang dana <br> yang masuk?
        </button>
      </h5>
    </div>
    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
      <div class="card-body">
        ...
        Ayoberbagi juga mewajibkan campaigner membuat update & Ayoberbagi.com.
          <br>
    ...
    <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordion">
      <div class="card-body">
        Ayoberbagi.com adalah website untuk menggalang dana dan berdonasi secara online terpopuler di Indonesia.

        Di luar negeri website sejenis disebut juga sebagai Crowdfunding Platform.
      </div>
    </div>
  </div>
            <div class="card">
    <div class="card-header" id="headingFive">
      <h5 class="mb-0">
        <button class="btn btn-link" data-toggle="collapse" data-target="#collapseFive" aria-expanded="true" aria-controls="collapseFive">
          Contoh galang dananya seperti apa?
        </button>
      </h5>
    </div>
