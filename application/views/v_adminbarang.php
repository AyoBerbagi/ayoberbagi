                ...
                <thead>
                  ...
                  <tbody>
                      ...
                      <tr>
                        ...
                        <td scope="col"><?php echo $u->id_berbagibarang ?></td>
                        <td scope="col"><?php echo $u->id_user ?></td>
                        <td scope="col"><?php echo $u->kategori_barang ?></td>
                        <td scope="col"><?php echo $u->bb_tanggal ?></td>
                        <td scope="col"><?php echo $u->bb_status ?></td>
                        <td scope="col">
                        <a
                            href="javascript:;"
                            data-id="<?php echo $u->id_berbagidana ?>"
                            data-nama="<?php echo $u->id_user ?>"
                            data-tanggal="<?php echo $u->bb_tanggal ?>"
          ...
          <div class="modal-dialog">
              <div class="modal-content">
                  <div class="modal-header">
                      ...
                      <h4 class="modal-title">Verifikasi Sumbangan Barang</h4>
                  </div>
                  <form class="form-horizontal" action="<?=base_url()?>Admin/verifikasi_barang" method="post" enctype="multipart/form-data" role="form">
      	            <div class="modal-body">
      	                    <div class="form-group">
      	                        <label class="col-lg-6 col-sm-2 control-label">Nama Desa</label>
      	                        <div class="col-lg-10">
      	                        	<input type="hidden" id="id" name="id">
                                  <input type="hidden" id="kampanye" name="kampanye">
