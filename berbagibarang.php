...
<body class="index-page sidebar-bagi8d54a2collapse">
    ...
    <!-- End Navbar -->
   <div class="section section-signup" style="background-image: url('assets/img/bb.jpg'); background-size: cover; background-position: top center; min-height: 700px;">
                <div class="container">
                    <div class="row">
              ...
              <div class="col-md-10 mb-3">
                ...
                <select class="custom-select d-block w-100" id="country" required>
                  <option value="">Berbagi Barang</option>
                ...
                <div class="invalid-feedback">
                  Please select a valid country.
                    ...
                    <div class="row" id="checkRadios">
                        <div class="col-sm-8 col-lg-6,5">
                            <div class="checkbox">
                                <input id="checkbox1" type="checkbox">
                                <label for="checkbox1">
                                   <p> Pernyataan </p>
                                    Dengan menyetujui pernyataan, Anda menyetujui syarat dan ketentuan kami. Anda akan menerima Notifikasi Email dari Ayo Berbagi.
                    ...
                    <div class="col text-center">
                        <a href="Home.html" class="btn btn-simple btn-round btn-white btn-lg" target="_blank">Lanjut</a>
                    </div>
                </div>
            </div>
